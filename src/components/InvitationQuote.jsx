  ...
  return (
    <section id="invitation-quote">
      ...
      <div className="inner-content text-shadow">
        ...
        <h3>
          We cordially invite you to honour us with your esteemed presence and
          blessings with Family and Friends on the auspicous occasion of the
          Wedding Ceremony of our youngest Son
        </h3>
      </div>
    </section>
  );
